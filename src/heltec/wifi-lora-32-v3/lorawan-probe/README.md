...
| `{"cmd":"fleet-begin","count":200,"interval":900,"anomalies":20,"epoch":…,"tzOffset":…,"channel":8}` | starts receiving a fleet; the running one stops. `channel` (optional) keeps every device to that one US915 channel at DR3, with ADR off, for the NDW LoRaWAN Gateway |
